...
namespace AvPurplePen
{
    ...
    public class DialogService : IDialogService
    {
        ...
        /// <summary>
        /// Shows the platform folder-picker dialog and returns the selected path.
        /// </summary>
        ...
        public async Task<string?> ShowSaveFilePickerAsync(string currentFileName, string? filterString)
        {
            ...
            var options = new FilePickerSaveOptions {
                Title = MiscText.SaveFileDialog_Title,
                SuggestedFileName = System.IO.Path.GetFileName(currentFileName),
                FileTypeChoices = filterString != null ? ParseFileFilters(filterString) : ParseFileFilters(MiscText.SaveFileDialog_PurplePenFilter)
            };
            if (System.IO.Path.GetDirectoryName(currentFileName) is string dir && dir.Length > 0)
